...
os.environ["ZHIPUAI_API_KEY"] = 'API_test'
if __name__ == "__main__":
    
    parser = argparse.ArgumentParser("FlipAttack")
    
    # victim LLM
    parser.add_argument("--victim_llm", type=str, default="glm-4-plus", 
                        choices=['glm-4-plus', "gpt-3.5-turbo-0125", "gpt-4-turbo-2024-04-09", "gpt-4-0613", "gpt-4o-2024-08-06", "gpt-4o-mini-2024-07-18",
    ...
    if args.data_name=='advbench':
        args.data_path = "harmful_chinese.csv"
